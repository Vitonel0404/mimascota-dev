...
from apps.report.models import ReportDefinition, ReportRequest
from apps.report.utils import create_base_report_template, json_default
...
def edit(request,report_type):
    ...
    *create_album_report_template* for this Demo App. Normally you'd probably
    ...
    return render(request, 'ReportBro/edit.html', context)
